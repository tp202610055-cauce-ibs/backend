...
/// <summary>
/// Consulta paginada del historial de síntomas del paciente autenticado en un rango de
/// fechas.
/// </summary>
...
public sealed record GetSymptomHistoryQuery(
    DateTime From,
    DateTime To,
    int Page = 1,
    int PageSize = 50) : IRequest<PagedResult<SymptomHistoryItem>>;
